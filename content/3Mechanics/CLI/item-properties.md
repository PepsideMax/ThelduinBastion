---
{"publish":true,"aliases":"Item Properties","created":"2025-06-13T17:11:40.700+02:00","modified":"2025-07-27T19:04:36.871+02:00","cssclasses":"json5e-note"}
---
...
A character can attempt to harvest poison from a venomous creature that is dead or has the [Incapacitated](/3Mechanics/CLI/conditions.md#Incapacitated) condition. The effort takes `dice:1d6|noform|noparens|avg` (`d6`) minutes, after which the character makes a DC 20 Intelligence ([Nature](/3Mechanics/CLI/skills.md#Nature)) check using a Poisoner's Kit. On a successful check, the character harvests enough poison for a single dose, and no additional poison can be harvested from that creature. On a failed check, the character is unable to extract any poison. If the character fails the check by 5 or more, the character is subjected to the creature's poison.